...
export const faculties = [
  {
    rom: 'i',
    name: 'Front End',
    skills: ['React', 'Next.js', 'TypeScript', 'JavaScript', 'HTML5 & CSS3', 'Tailwind CSS', 'WebRTC', 'Canvas & Motion'],
    delay: 0,
  },
  {
    rom: 'ii',
    name: 'Back End',
    skills: ['Node.js', 'Express', 'Python', 'REST & GraphQL', 'PostgreSQL', 'MongoDB', 'WebSockets', 'Redis'],
    delay: 0.08,
  },
  {
    rom: 'iii',
    name: 'General',
    skills: ['System Design', 'Git & CI/CD', 'AI / LLM Integration', 'Computer Vision', 'Cloud · AWS', 'Agile', 'Business Development', 'UI / UX'],
    delay: 0.16,
  },
] as const;
...
export const writings = [
  {
    ...
    meta: 'Essay · 12 min',
    tag: 'Essay · The Self',
    excerpt: 'On refusing to specialise — why breadth of curiosity still matters in an age that pays the narrow.',
  ...
  },
  {
    ...
    excerpt: 'Our focus has become the scarcest resource of the century. Notes on noticing, and on taking it back.',
  ...
  },
  {
    ...
    meta: 'Essay · 14 min',
    tag: 'Essay · Economy',
    excerpt: 'When platforms quietly become landlords — who really owns the commons we all now live inside?',
  ...
  },
  {
    ...
    meta: 'Essay · 8 min',
    tag: 'Essay · Living',
    excerpt: 'Essentialism as a design principle for a life — subtracting until only what truly matters remains.',
